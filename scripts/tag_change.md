# Tag Unification Recommendations – AJC Library

> Generated: 2026-03-18  
> Source: `scripts/tags_count.txt` (2898 unique tags, 12 008 total usages)

Each section below lists tags that should be merged, the **→ keep** canonical tag,
...
## 1. Case / capitalisation duplicates
...
→ keep:    halál (138)
  ...
  replace: halál utáni élet (7)
  replace: halál után (19)
  replace: halálközeli élmény (5)  → alternatively keep separate as it is specific
  replace: élet a halál után (2)
  replace: halál utáni állapot (2)
  replace: halál utáni tapasztalat (1)
  replace: halál utáni tudat (1)
  replace: halál utáni események (1)
...
→ keep:    reinkarnáció (32)
  ...
  replace: újratestesülés (1)
  replace: leszületés (2)
  replace: megtestesülés (2)
  replace: inkarnáció (6)
  replace: következő élet (4)
```
...
→ keep:    ego (33)
  replace: egó (2)
  replace: egoizmus (4)
  replace: ultraegoizmus (1)  → optionally keep as sub-type
```
...
→ keep:    nárcizmus (5)
  replace: narcizmus (1)
  replace: nárcisztikus (1)
  replace: nárcisztikus kapcsolat (1)
  replace: narcisztikus személyiségzavar (1)
```
...
→ keep:    párkapcsolat (102)
  ...
  replace: párkeresés (2)
  replace: társkeresés (1)
  replace: társ bevonzása (1)
  replace: ismerkedés (5)    → may keep separate (=dating), review
```
...
→ keep:    sors (56)
  ...
  replace: eleve elrendeltség (−)
  replace: predesztináció (2)
  replace: determináció (3)
  replace: előre elrendeltség (1)
  replace: előre megírt élet (1)
  replace: előre megírtság (1)
  replace: meg van írva (1)
  replace: kollektív sors (2)   → optional: keep with note
  replace: örökölt sors (2)     → optional: consider keeping with `örökség`
```
...
→ keep:    karma (29)
  replace: karmikus (3)
  replace: karmikus adósság (1)
  replace: karmikus terhek (1)
  replace: csoport karma (1)
  replace: csoportos karma (1)
  replace: negatív karma (1)
```
...
→ keep:    tudatosság (182)
  ...
  replace: tudatos (1)
  replace: tudatos élet (2)
  replace: tudatos ember (2)
  replace: öntudatosság (1)
```
...
→ keep:    jelenlét (27)
  ...
  replace: tudatos figyelem (14)   → already captured above as cap-merge too
  replace: tudatos befogadás (1)
  replace: itt és most (1)
  replace: most (2)
  replace: jelen (3)
```
...
→ keep:    fejlődés (40)
  ...
  replace: egyéni fejlődés (1)
  replace: belső fejlődés (1)
  replace: lelki fejlődés (5)
  replace: szellemi fejlődés (4)
...
→ keep:    gyógyulás (26)
  ...
  replace: öngyógyítás (5)
  replace: lelki gyógyulás (2)
  replace: kvantum gyógyítás (1)
  replace: kvantumgyógyítás (1)
  replace: szellemgyógyászat (1)
  replace: energiagyógyászat (2)
  replace: távolgyógyítás (2)
```
...
→ keep:    betegség (39)
  ...
  replace: mentális betegség (1) [see `pszichés betegség`]
  replace: pszichés betegség (1)
  replace: krónikus betegség (1)
  replace: veleszületett betegség (1)
  replace: daganatos betegség (1)
```
...
→ keep:    energia (33)
  replace: energiák (2)
  replace: energetika (9)
  replace: energetikai kapcsolat (1)
  replace: energetikai hatás (1)
  replace: energetikai lenyomat (1)
  replace: energetikai változás (1)
  replace: energetikai tisztítás (1)
  replace: energiamező (2)
  replace: energiacsere (1)
  replace: energiafolyam (1)
  replace: energiaközpontok (1)
```
...
→ keep:    vonzás törvénye (4)
  ...
  replace: manifestáció (2)      ← typo variant
  replace: valóságteremtés (2)
  replace: bevonzás (1)
  replace: tudatos teremtés (14) → keep or merge
```
...
→ keep:    önismeret (125)
  ...
  replace: önmegismerés (2)
  replace: önvizsgálat (1)
  replace: önmegfigyelés (6)
  replace: önmegvalósítás (3)
  replace: önkifejezés (3)
```
...
→ keep:    segítség (26)
  ...
  replace: segítők (8)
  replace: segítő (2)
  replace: segítő szakma (2)
  replace: segítségnyújtás (2)
  replace: segítő munka (1)
  replace: segítő szerep (1)
  replace: segítség elfogadása (1)
  replace: szociális segítség (1)
  replace: mások segítése (2)
  replace: önzetlen segítség (1)
```
...
→ keep:    háború (29)
  ...
  replace: ukrán orosz háború (2)
  replace: orosz ukrán háború (1)
  replace: nyersanyag háború (1)
  replace: nyersanyagháború (1)
  replace: harmadik világháború (3)
  replace: III. világháború (1)
  replace: II. Világháború (1)
  replace: világháború (1)
```
...
→ keep:    meditáció (20)
  ...
  replace: vezeted meditáció (2)
  replace: igazi meditáció (1)
  replace: halál meditáció (1)
  replace: békemeditáció (1)
  replace: meditáció hatása (1)
```
...
→ keep:    lelkiállapot (6)
  ...
  replace: lelki (2)
  replace: lelki háttér (1)
  replace: lelki hatás (1)
  replace: lelki hatások (1)
  replace: lelki okok (3)
  replace: testi állapot (1)  → this belongs under `test`
```
...
→ keep:    tudatos álmodás (6) [lucid dreaming – distinct concept]
  replace: álmodás (3)         → merge into `álom`
  replace: álmodozás (2)       → merge into `álom`
  replace: tudatos álom (2)    → merge into `tudatos álmodás`
  replace: közös álom (1)      → merge into `álom`
  replace: álomfejtés (1)      → consider keeping as specific
```
...
→ keep:    testkilépés (7)
  ...
  replace: test nélküli létezés (2)
```
...
→ keep:    megvilágosodás (36)
  ...
  replace: ébredés (3)
  replace: spirituális ébredés (3)
  replace: eszmélés (1)
  replace: felébresztés (1)
```
...
→ keep:    spirituális út (12)
  replace: lelki út (1)
  replace: szellemi út (4)
  replace: szellemi fejlődés (4)  → already in 3j
  replace: spirituális útkeresés (1)
  replace: útkeresés (13)         → review: could be general life search; keep if not exclusive spiritual
```

---

## 4. Clearly erroneous / junk tags
...
## 6. Overly specific tags that could roll up to a parent
